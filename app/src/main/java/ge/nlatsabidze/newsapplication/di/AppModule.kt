...
object AppModule {
    ...
    fun provideUseCase(newsRepository: NewsRepository): NewsUseCase {
        return NewsUseCase.GetNewsUseCase(newsRepository)
    }
    ...
    @Provides
    fun provideInternetConnection(@ApplicationContext context: Context): ProvideInternetConnectionChecker {
        return ProvideInternetConnectionChecker.NetworkHelper(context)
    }
